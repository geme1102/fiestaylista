...
export default function App() {
  ...
  return (
    <QueryProvider>
      ...
      <OfflineBanner />
      <ScrollToTop />
    <Suspense fallback={<div className="min-h-screen flex flex-col items-center justify-center gap-4 bg-surface"><Logo className="w-16 h-16" alt="Fiesta y Lista" /><div className="w-8 h-8 rounded-full border-2 border-primary border-t-transparent animate-spin" /><p className="text-sm text-on-surface-variant/80 font-medium animate-pulse">Cargando...</p></div>}>
      <TitleUpdater />
