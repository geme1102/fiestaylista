    ...
    <section className="mb-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5 px-1">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex flex-col text-left">
            ...
            <span className="text-xs text-on-surface-variant font-semibold">{gifts.length}{maxGiftsPerEvent ? ` / ${maxGiftsPerEvent}` : ''} — Tus invitados elegirán los regalos directo de esta lista</span>
          </div>
        </div>
      </div>
      ...
      {gifts.length === 0 ? (
        <div className="bg-surface-container-low/60 border border-outline-variant/30 rounded-3xl p-12 text-center">
          ...
          <p className="text-on-surface-variant text-xs mt-1 font-medium">Agrega tu primer regalo usando el formulario de arriba.</p>
        </div>
      ) : (
