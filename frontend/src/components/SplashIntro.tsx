...
export default function SplashIntro({ onComplete }: SplashIntroProps) {
  ...
  return (
    <div
      aria-hidden="true"
      className="fixed inset-0 w-full h-full flex items-center justify-center z-[9999] select-none animate-splash-fade"
      style={{
        background: 'linear-gradient(135deg, #8c0053, #d23284, #2f2ebe, #ffb77d, #c0c1ff)'
      }}
    >
      <div
        className="px-6 sm:px-10 py-4 sm:py-6 rounded-[2.5rem] flex items-center justify-center border-t-white/50 border-l-white/40 border-b-white/10 border-r-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.2),inset_0_1px_3px_rgba(255,255,255,0.4)] bg-white/15 animate-splash-content"
        style={{
