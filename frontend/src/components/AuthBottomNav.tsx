...
export default function AuthBottomNav() {
  ...
  return (
    <nav aria-label="Navegación inferior" data-testid="bottom-nav" className="fixed bottom-0 left-0 right-0 z-50 sm:hidden crystal-nav border-t border-white/20 shadow-[0_-4px_20px_rgba(177,14,107,0.1)] pb-safe rounded-t-xl">
