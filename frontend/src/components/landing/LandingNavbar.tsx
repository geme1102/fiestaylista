...
export function LandingNavbar({ scrolled, isAuthenticated }: LandingNavbarProps) {
  return (
    <nav aria-label="Navegación principal" className={`sticky top-0 z-50 crystal-nav border-b border-white/20 transition-all duration-300 pt-safe ${scrolled ? 'shadow-primary/5' : ''}`}>
