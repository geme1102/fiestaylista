      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="glass rounded-2xl p-5 md:p-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-on-surface-variant mt-0.5 font-medium uppercase tracking-wide">Eventos</p>
          </div>
        </div>
        ...
        <div className="glass rounded-2xl p-5 md:p-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-on-surface-variant mt-0.5 font-medium uppercase tracking-wide">Regalos</p>
          </div>
        </div>
        ...
        <div className="glass rounded-2xl p-5 md:p-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-on-surface-variant mt-0.5 font-medium uppercase tracking-wide">Visitas totales</p>
          </div>
        </div>
