export function getGiftImage(name: string): string {
  ...
  if (lower.includes('alianza') || lower.includes('boda') || lower.includes('wedding')) return '/icons/gift-wedding.svg';
...
export function getGiftCategory(name: string): { label: string; color: string } {
  ...
  if (lower.includes('vajilla') || lower.includes('sábanas') || lower.includes('cristalería') || lower.includes('boda') || lower.includes('alianza')) return { label: 'Boda', color: '#6366f1' };
  ...
  if (lower.includes('medalla') || lower.includes('cadena') || lower.includes('joyería') || lower.includes('anillo') || lower.includes('reloj') || lower.includes('pulsera') || lower.includes('collar')) return { label: 'Joyería', color: '#eab308' };
